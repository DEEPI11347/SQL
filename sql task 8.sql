...
VALUES
(101, 'Deepika', 'deepika@gmail.com', 'Mysore'),
(102, 'alriya', 'alriya@gmail.com', 'Chennai'),
(103, 'jenevia', 'jenevia@gmail.com', 'Bangalore'),
(104, 'ananya', 'ananya@gmail.com', 'Mangalore'),
(105, 'andrea', 'andrea@gmail.com', 'Kochi');
...
VALUES
(1, 101, 2000, '2026-03-10'),
(2, 102, 6000, '2026-05-12'),
(3, 101, 5000, '2026-04-10'),
(4, 103, 1000, '2026-07-21'),
(5, 104, 8000, '2026-06-07'),
(6, 102, 3000, '2026-05-10'),
(7, 103, 9000, '2026-01-30'),
(8, 104, 4000, '2026-02-20'),
(9, 105, 3000, '2026-03-21'),
(10, 105, 4000, '2026-05-14'),
(11, 101, 1000, '2026-06-25'),
...
VALUES
(501, 101, 2000, '2026-03-10', '2026-08-10', 'Paid'),
(502, 102, 6000, '2026-05-12', '2026-08-15', 'Unpaid'),
(503, 103, 1000, '2026-07-21', '2026-08-20', 'Unpaid'),
(504, 104, 4000, '2026-08-20', '2026-08-25', 'Unpaid'),
(505, 105, 3000, '2026-04-21', '2026-08-28', 'Paid');
